...
export function Navbar({ categories: initialCategories = [] }: { settings?: Record<string, string>, categories?: CategoryNav[] }) {
  ...
  return (
    <div
      className={`flex justify-between items-center fixed top-0 left-0 right-0 py-3 px-4 sm:px-6 lg:px-10 z-50 transition-all duration-300 overflow-x-hidden ${isScrolled ? " backdrop-blur-md" : "bg-transparent"}`}
    >
